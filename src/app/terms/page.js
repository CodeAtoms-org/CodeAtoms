      ...
      <section className="min-h-screen bg-white text-gray-800 px-6 md:px-20 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 mb-16">
            <div>
              <h2 className="text-2xl font-semibold text-[#006D77] mb-2">1. Use of Platform</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#006D77] mb-2">2. Intellectual Property</h2>
              <p className="text-gray-600">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#006D77] mb-2">3. Limitation of Liability</h2>
              <p className="text-gray-600">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#006D77] mb-2">4. Account Termination</h2>
              <p className="text-gray-600">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#006D77] mb-2">5. Updates</h2>
              <p className="text-gray-600">
