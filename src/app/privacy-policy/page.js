      ...
      <section className="min-h-screen bg-white text-gray-800 px-6 md:px-20 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl  text-[#006D77] mb-2">1. Information We Collect</h2>
            ...
            <div>
              <h2 className="text-2xl  text-[#006D77] mb-2">2. How We Use Information</h2>
              <p className="text-gray-600">
            ...
            <div>
              <h2 className="text-2xl  text-[#006D77] mb-2">3. Data Protection</h2>
              <p className="text-gray-600">
            ...
            <div>
              <h2 className="text-2xl  text-[#006D77] mb-2">4. Cookies</h2>
              <p className="text-gray-600">
